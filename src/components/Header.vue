<template>
  <div class="container mx-auto">
    ...
    <div v-if="menuOpen" class="md:hidden">
      <ul class="flex flex-col items-center bg-[#1C1E53] shadow-md py-4">
        <router-link @click="closeMenu" to="/home" class="py-2 text-white hover:text-gray-400">Home</router-link>
        <router-link @click="closeMenu" to="/about" class="py-2 text-white hover:text-gray-400">About us</router-link>
